...
if ( !class_exists( 'MMQW_Min_Max_Quantity_For_WooCommerce_Public' ) ) {
    class MMQW_Min_Max_Quantity_For_WooCommerce_Public {
        ...
        public function mmqw_enqueue_scripts() {
            ...
            wp_localize_script( $this->plugin_name, 'mmqw_plugin_vars', array(
                ...
                'change_qty_html' => apply_filters( 'mmqw_change_qty_html', true ),
            ) );
        }
        ...
        /**
         * Get dots sample products quantity from cart
         *
         * @since 1.0.0
         * 
         * @return array
         */
        public function mmqw_get_dsfps_sample_product_cart_item_qty() {
            $quantities = array();
         ...
         *
         * @param bool $skip_cart_actions Whether to skip cart-specific actions (like hiding checkout button). Default false.
         *
         * @since 3.1.3
         */
        public function mmqw_min_max_quantities_proceed_to_checkout_conditions( $skip_cart_actions = false ) {
            global $woocommerce;
            ...
            //for cart total
            $fps_sample_qty = $this->mmqw_get_dsfps_sample_product_cart_item_qty();
            $total_cart_quantity = $woocommerce->cart->cart_contents_count;
            $total_cart_quantity = $total_cart_quantity - array_sum( $fps_sample_qty );
            ...
            // end: check exclude product list and modify the total_cart_quantity based on exclude_product_list and exclude_category_list
            /**
            ...
            // end: check exclude product list and modify the total_cart_amount based on exclude_product_list and exclude_category_list for cart total
            /**
            ...
            foreach ( $woocommerce->cart->get_cart() as $val ) {
                ...
                // end:check exclude product list and modify the cart_product_quantity based on exclude_product_list and exclude_category_list
