...
class MMQW_Min_Max_Quantity_For_WooCommerce_Admin
{
    ...
    public function mmqw_enqueue_scripts( $hook )
    {
        ...
        if ( false !== strpos( $hook, '_page_mmqw' ) || false !== strpos( $hook, '_page_mmqw' ) ) {
            wp_enqueue_script(
            ...
            wp_localize_script( $this->plugin_name, 'coditional_vars', array(
                ...
                'qty_on_product'          => esc_html__( 'Qty on Product', 'min-and-max-quantity-for-woocommerce' ),
                'qty_on_variable_product' => esc_html__( 'Qty on Variable Product', 'min-and-max-quantity-for-woocommerce' ),
                'qty_on_category_product' => esc_html__( 'Qty on Category', 'min-and-max-quantity-for-woocommerce' ),
                'qty_on_country'          => esc_html__( 'Qty on Country', 'min-and-max-quantity-for-woocommerce' ),
    ...
    public function mmqw_dot_store_plugin_menu_integration()
    {
        ...
        add_submenu_page(
            ...
            'manage_options',
            'mmqw-information',
            array( $this, 'mmqw_information_page' )
        );
    ...
    public function mmqw_admin_footer_review()
    {
        ...
        $review_on = 'WP.org';
        echo  sprintf( wp_kses( __( 'If you like <strong>Minimum and Maximum Quantity for WooCommerce</strong> plugin, please leave us ★★★★★ ratings on <a href="%1$s" target="_blank">' . $review_on . '</a>.', 'min-and-max-quantity-for-woocommerce' ), array(
            'strong' => array(),
            'a'      => array(
            'href'   => array(),
            'target' => array(),
    ...
    public function mmqw_add_new_group_html_ajax()
    {
        ...
        ?></h2>
                            <div class="tap">
                                <a class="button button-primary button-large mmqw-add-new-rule" href="javascript:void(0);"><?php 
        ...
        ?></a>
                        ...
                        <div class="mmqw-conditions-doc">
                            ...
                            <a href="<?php 
        echo  esc_url( 'https://docs.thedotstore.com/article/715-how-to-create-a-new-min-max-rule' ) ;
        ?>" target="_blank"><?php 
        esc_html_e( 'View Documentation', 'min-and-max-quantity-for-woocommerce' );
        ?></a>
                        </div>
                    </div>
                    <div class="tap">
        ...
        esc_html_e( 'Qty on Product', 'min-and-max-quantity-for-woocommerce' );
        ?></option>
                                                <option value="variable_product"><?php 
        esc_html_e( 'Qty on Variable Product', 'min-and-max-quantity-for-woocommerce' );
        ?></option>
                                                <option value="category"><?php 
        esc_html_e( 'Qty on Category', 'min-and-max-quantity-for-woocommerce' );
        ?></option>
                                            </optgroup>
                                            <optgroup label="<?php 
        ...
        esc_html_e( 'Qty on Country', 'min-and-max-quantity-for-woocommerce' );
        ?></option>
                                            </optgroup>
                                        </select>
                                    </th>
        ...
        echo  esc_attr( $mmqw_total_groups_no ) ;
        ?>][mmqw_rule][0][mmqw_rule_condition_value][]" class="mmqw_product mmqw_product_rule_condition_val multiselect2 min_max_select" multiple="multiple" data-placeholder="Please enter 3 or more characters">
                                        </select>
                                    </td>
        ...
        echo  esc_attr( $mmqw_total_groups_no ) ;
        ?>_min_qty" placeholder="Min quantity" value="" min="0">
                                        <?php 
        ...
        echo  esc_attr( $mmqw_total_groups_no ) ;
        ?>_max_qty" placeholder="Max quantity" value="" min="0">
                                        <?php 
