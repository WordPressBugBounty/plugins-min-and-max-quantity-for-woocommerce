			...
			<div class="wrap">
				<form method="post" enctype="multipart/form-data">
					<div class="mmqw-main-table">
						...
						<a class="page-title-action mmqw-btn-with-brand-color" href="<?php echo esc_url( $link ); ?>"><?php esc_html_e( 'Add New', 'min-and-max-quantity-for-woocommerce' ); ?></a>
						<a class="shipping-methods-order page-title-action" style="display:none;"><?php esc_html_e( 'Save Order', 'min-and-max-quantity-for-woocommerce' ); ?></a>
						<?php
