...
if ( isset( $_POST['submitCheckoutSettings'] ) && ! empty( $_POST['submitCheckoutSettings'] ) ) {
	...
	if ( ! wp_verify_nonce( $post_retrieved_nonce, 'mmqw_checkout_settings_save_action' ) ) {
		...
		$post_data['min_order_value']    = filter_input(INPUT_POST,'min_order_value',FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
		$post_data['max_order_value']    = filter_input(INPUT_POST,'max_order_value',FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
		...
		<table class="form-table table-outer min-max-option-table">
			...
			<tr valign="top">
				<td class="fr-1" scope="row">
					...
					<?php echo wp_kses( wc_help_tip( esc_html__( 'Add minimum order quantity to add on order page. eg., 10.', 'min-and-max-quantity-for-woocommerce' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
				</td>
				<td class="fr-2">
					<input type="number" name="min_order_quantity" class="num-class qty-class" id="min_order_quantity" value="<?php echo esc_attr( $min_order_quantity ); ?>" min="0" placeholder="<?php esc_attr_e( 'eg. 10', 'min-and-max-quantity-for-woocommerce' ); ?>">
				</td>
			</tr>
			<tr valign="top">
				<td class="fr-1" scope="row">
					...
					<?php echo wp_kses( wc_help_tip( esc_html__( 'Add maximum order quantity to add on order page. eg., 10.', 'min-and-max-quantity-for-woocommerce' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
				</td>
				<td class="fr-2">
					<input type="number" name="max_order_quantity" class="num-class qty-class" id="max_order_quantity" value="<?php echo esc_attr( $max_order_quantity ); ?>" min="0" placeholder="<?php esc_attr_e( 'eg. 10', 'min-and-max-quantity-for-woocommerce' ); ?>">
				</td>
			</tr>
			<tr valign="top" aria-colspan="2">
				<td class="fr-1 title_td" scope="row" colspan="2">
			...
			<tr valign="top">
				<td class="fr-1" scope="row">
					...
					<?php echo wp_kses( wc_help_tip( esc_html__( 'Add minimum order value to add on order page. eg., 10.', 'min-and-max-quantity-for-woocommerce' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
				</td>
				<td class="fr-2">
					<input type="number" name="min_order_value" class="num-class" id="min_order_value" value="<?php echo esc_attr( $min_order_value ); ?>" min="0" step="0.01" placeholder="<?php esc_attr_e( 'eg. 10', 'min-and-max-quantity-for-woocommerce' ); ?>">
				</td>
			</tr>
			<tr valign="top">
				<td class="fr-1" scope="row">
					...
					<?php echo wp_kses( wc_help_tip( esc_html__( 'Add maximum order value to add on order page. eg., 10.', 'min-and-max-quantity-for-woocommerce' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
				</td>
				<td class="fr-2">
					<input type="number" name="max_order_value" class="num-class" id="max_order_value" value="<?php echo esc_attr( $max_order_value ); ?>" min="0" step="0.01" placeholder="<?php esc_attr_e( 'eg. 10', 'min-and-max-quantity-for-woocommerce' ); ?>">
				</td>
			</tr>
			<tr valign="top" aria-colspan="2">
				<td class="fr-1 title_td" scope="row" colspan="2">
			...
			<tr valign="top">
				<td class="fr-1" scope="row">
					...
					<?php echo wp_kses( wc_help_tip( esc_html__( 'Add minimum items quantity to add on order page. eg., 10.', 'min-and-max-quantity-for-woocommerce' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
				</td>
				<td class="fr-2">
					<input type="number" name="min_items_quantity" class="num-class" id="min_items_quantity" value="<?php echo esc_attr( $min_items_quantity ); ?>" min="0" placeholder="<?php esc_attr_e( 'eg. 10', 'min-and-max-quantity-for-woocommerce' ); ?>">
				</td>
			</tr>
			<tr valign="top">
				<td class="fr-1" scope="row">
					...
					<?php echo wp_kses( wc_help_tip( esc_html__( 'Add maximum items quantity to add on order page. eg., 10.', 'min-and-max-quantity-for-woocommerce' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
				</td>
				<td class="fr-2">
					<input type="number" name="max_items_quantity" class="num-class" id="max_items_quantity" value="<?php echo esc_attr( $max_items_quantity ); ?>" min="0" placeholder="<?php esc_attr_e( 'eg. 10', 'min-and-max-quantity-for-woocommerce' ); ?>">
				</td>
			</tr>
			<tr valign="top" aria-colspan="2">
				<td class="fr-1" scope="row" colspan="2">
					<p class="submit">
						<input type="submit" name="submitCheckoutSettings" class="button button-primary button-large" value="<?php echo esc_attr( $submit_text ); ?>">
					</p>
				</td>
			</tr>
			</tbody>
