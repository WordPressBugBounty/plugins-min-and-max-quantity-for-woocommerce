...
<div class="mmqw-main-table res-cl mmqw-get-started-table">
	<h2><?php esc_html_e( 'Getting Started', 'min-and-max-quantity-for-woocommerce' ); ?></h2>
		...
		<tr>
			<td class="fr-2">
				<p class="block textgetting">
					<?php
					echo sprintf( wp_kses( __( 'Go to <strong>Settings > General</strong> to Add the Min Max global settings value as per your business need.' , 'min-and-max-quantity-for-woocommerce' )
						, array( 'strong' => array() ) ) );
					?>
				</p>
				<p class="block textgetting">
