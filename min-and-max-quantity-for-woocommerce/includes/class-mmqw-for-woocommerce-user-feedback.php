				...
				<div class="editorsMinMaxWoo-notice-inner">
					...
					<div class="editorsMinMaxWoo-notice-content">
						...
						<p>
							...
							<?php printf( esc_html__( 'You have been using %1$s for %2$s now. Mind leaving a review to let us know what you think? We\'d really appreciate it!', 'min-and-max-quantity-for-woocommerce' ), esc_html( $this->name ), esc_html( $time ) ); ?>
						</p>
					</div>
