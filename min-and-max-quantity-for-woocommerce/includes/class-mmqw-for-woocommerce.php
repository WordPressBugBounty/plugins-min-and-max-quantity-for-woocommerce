...
class Min_Max_Quantity_For_WooCommerce {
	...
	private function mmqw_define_admin_hooks() {
		...
		$this->loader->add_filter( 'set-screen-option', $plugin_admin, 'mmqw_set_screen_options', 10, 3 );
		...
		$this->loader->add_action( 'upgrader_process_complete', $plugin_admin, 'mmqw_migrate_plugin_settings_on_update', 10, 2 );
	...
	private function mmqw_define_public_hooks() {
		...
		$this->loader->add_filter( 'woocommerce_available_variation', $plugin_public, 'mmqw_woocommerce_quantity_min_max_variation', 10, 2 );
		...
		$this->loader->add_filter( 'woocommerce_add_to_cart_validation', $plugin_public, 'mmqw_add_to_cart_validation', 10, 5 );
	}
	...
	public function plugin_action_links( $actions ) {
		$custom_actions = array(
			'configure' => sprintf( '<a href="%s">%s</a>', esc_url( add_query_arg( array( 'page' => 'mmqw-rules-list' ), admin_url( 'admin.php' ) ) ), __( 'Settings', 'min-and-max-quantity-for-woocommerce' ) ),
